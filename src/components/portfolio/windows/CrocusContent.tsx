	...
	return (
		<div style={{ display: "flex", flexDirection: "column", width: "100%", height: "100%" }}>
			...
			<div style={{ display: "flex", alignItems: "center", gap: 6, padding: "4px 6px", background: BG, borderBottom: "1px solid #808080", flexShrink: 0 }}>
				...
				<div style={{ ...sunken, flex: 1, padding: "1px 6px", background: "#ffffff", fontFamily: FONT, fontSize: 11 }}>
					{url}
				</div>
				<button
			...
			{/* Content */}
			{blocked ? (
				<div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 12, background: "#ffffff", fontFamily: FONT }}>
